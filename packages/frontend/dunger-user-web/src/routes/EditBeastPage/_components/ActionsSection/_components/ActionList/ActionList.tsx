...
export const ActionList = ({ groupId, opened, name, style, setValue }: ActionListProps) => {
  ...
  const { data: actions, isLoading } = useQuery({
    queryKey: ['creatures', 'actions', groupId],
    queryFn: () => authFetch<ApiAction[]>(`/creatures/actions/groups/${groupId}`),
